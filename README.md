...
| [`pocs/sparkroom`](pocs/sparkroom) | Multiplayer-AI workspace — pitch an idea, it becomes a live room where humans and an AI peer chat and co-write one shared draft — every edit attributed, undoable, and merged when two people write at once. Runs as a Claude.ai Artifact | ✅ Active (v0.1.0) |
