...
| File | Role |
|---|---|
| `ratios.js` | Pure logic: format/film data, letterbox coverage, equal-width area gain, frame sizing for both view modes, crop-line math. No DOM. |
| `app.js` | UI wiring, canvas demo scene, ratio-shift player, media loading. |
