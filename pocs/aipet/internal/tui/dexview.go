...
// mostly unseen, a single column wastes most of a screen's height. The full
// grid renders even with zero data: 30 unseen slots is itself the "here's
// what's coming" motivation for a brand-new user, so it's never hidden
// behind a "no data yet" message.
